...
INSERT INTO public.products (category_id, name, description, price, weight_grams, image_name) VALUES ((SELECT category_id FROM categories WHERE name='Эклеры'), 'Эклер Голубика', '', 0, 0, 'product4.webp');
